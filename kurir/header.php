<h2><strong>Home Kurir</strong></h2>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <!-- Masthead Avatar Image -->
       <img class="masthead-avatar mb-12 rounded-circle" src="img/avataaars.svg" alt="">


      <!-- Masthead Heading -->
      <h1 class="masthead-heading text-uppercase mb-0">Selamat Bekerja</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <img class="img-fluid" src="img/portfolio/cabin.png" alt=""><p><center>Data Penjemputan</center></p>
        ...
        <div class="col-md-6 ">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <img class="img-fluid" src="img/portfolio/cake.png" alt=""><p><center>Transaksi</center></p>
          </div>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; RatnaYeniYonathan</small>
    </div>
  </section>
                ...
                <?php include '../koneksi.php'; ?>
                          ...
                          <table class="table table-bordered text-center">
                            ...
                            <tbody>
                              ...
                              <?php $ambil = $koneksi->query('SELECT * FROM data_penjemputan'); ?>
                              <?php while ($tampil = $ambil->fetch_assoc()) {
                              ?>
                              
                              <tr>
                                <td><?php echo $tampil['id_jemput']; ?></td>
                                <td><?php echo $tampil['id_user']; ?></td>
                                <td><?php echo $tampil['id_transaksi']; ?></td>
                                <td><?php echo $tampil['id_sampah']; ?></td>
                                <td><?php echo $tampil['status']; ?></td>

                                <td> <a href="menu.php?halaman=edit_user&id=<?php echo $tampil['id_user'] ?>" class="btn btn-info"> Jemput</a>
        ...
        <div class="modal-body text-center">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <!-- Portfolio Modal - Title -->
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">TRANSAKSI</h2>
                <!-- Icon Divider -->
                <div class="divider-custom">
                  <div class="divider-custom-line"></div>
                  <div class="divider-custom-icon">
                ...
                <?php include '../koneksi.php'; ?>
                        ...
                        <a href="menu.php?halaman=tambah_transaksi" class="btn btn-primary"> Tambah Transaksi </a>
